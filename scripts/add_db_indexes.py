...
def add_indexes():
    ...
    with engine.connect() as conn:
        ...
        try:
            conn.execute(text("CREATE INDEX IF NOT EXISTS idx_documents_upload_date ON documents(upload_date);"))
        ...
        try:
            conn.execute(text("CREATE INDEX IF NOT EXISTS idx_documents_user_date ON documents(user_id, upload_date DESC);"))
